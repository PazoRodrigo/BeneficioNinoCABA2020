...
#Region " Constructores "
        ...
        Sub New(ByVal id As Integer)
            'Dim lista As List(Of TipoBeneficio =
            'Dim objImportar As TipoBeneficio = TraerUno(id)
            '' DBE
        ...
        Sub New(ByVal objDesdeDTOTipoBeneficio As DTO.DTO_TipoBeneficio)
            ' Entidad
            IdEntidad = objDesdeDTOTipoBeneficio.IdEntidad
            Nombre = objDesdeDTOTipoBeneficio.Nombre
        End Sub
#End Region
#Region " Métodos Estáticos"
        ' Traer
        'Public Shared Function TraerUno(ByVal Id As Integer) As TipoBeneficio
        '    Dim result As TipoBeneficio = Todos.Find(Function(x) x.IdEntidad = Id)
        '    If result Is Nothing Then
        '        Throw New Exception("No existen resultados para la búsqueda")
        '    End If
        '    Return result
        'End Function
        'Public Shared Function TraerTodos() As List(Of TipoBeneficio)
        '    Return Todos
        'End Function


        Public Shared Function TraerTodos() As List(Of DTO.DTO_TipoBeneficio)
            Dim L As List(Of TipoBeneficio) = DAL_TipoBeneficio.TraerTodos()
            Dim result As New List(Of DTO.DTO_TipoBeneficio)
            For Each item As TipoBeneficio In L
        ...
        Public Shared Sub EnviarEMail(IdAfiliado As Integer)
            Try
                'Dim Lista As List(Of TipoBeneficio) = DAL_TipoBeneficio.TraerTodosPorTitular(IdAfiliado)
                ...
                '        Mail.Subject = "TipoBeneficio TipoBeneficio Día de la Niñez !!!"
                '        Mail.Body = str
...
#Region " Métodos Públicos"
        ...
        Public Sub Alta()
            ValidarAlta()
            DAL_TipoBeneficio.Alta(Me)
        End Sub
        Public Sub Baja()
            ValidarBaja()
            DAL_TipoBeneficio.Baja(Me)
        End Sub
        Public Sub Modifica()
            ValidarModifica()
            DAL_TipoBeneficio.Modifica(Me)
        End Sub


        ' Otros
        Public Function ToDTO() As DTO.DTO_TipoBeneficio
            Dim result As New DTO.DTO_TipoBeneficio
            result.IdEntidad = IdEntidad
            result.Nombre = Nombre
            Return result
        End Function
        'Public Shared Sub refresh()
        '    _Todos = DAL_TipoBeneficio.TraerTodos
        'End Sub
        ' Nuevos
#End Region
#Region " Métodos Privados "
        ...
        Private Sub ValidarNoDuplicados()
            'Dim cantidad As Integer = DAL_TipoBeneficio.TraerTodosXDenominacionCant(Me.denominacion)
        ...
        End Sub
#End Region
    End Class ' TipoBeneficio
End Namespace ' Entidad

Namespace DTO
    Public Class DTO_TipoBeneficio
        'Inherits DTO_DBE
...
#Region " Atributos / Propiedades"
        ...
        Public Property Nombre() As String = ""
#End Region
    End Class ' DTO_TipoBeneficio
End Namespace ' DTO



Namespace DataAccessLibrary
    Public Class DAL_TipoBeneficio
...
#Region " Stored "
        ...
        Const storeTraerTodos As String = "[Beneficios].[usp_traer_Tiposbeneficios]"
        Const storeTraerTodosActivos As String = ""
#End Region
#Region " Métodos Públicos "
        ' ABM
        Public Shared Sub Alta(ByVal entidad As TipoBeneficio)
            ...
            End Using
        End Sub
        Public Shared Sub Baja(ByVal entidad As TipoBeneficio)
            Dim store As String = storeBaja
            Dim pa As New parametrosArray
            pa.add("@id", entidad.IdEntidad)
            Connection.Connection.Ejecutar(store, pa, "strConn_CABA")
        End Sub
        Public Shared Sub Modifica(ByVal entidad As TipoBeneficio)
        ...
        Public Shared Function TraerTodos() As List(Of TipoBeneficio)
            ...
            Dim pa As New parametrosArray
            Dim listaResult As New List(Of TipoBeneficio)
...
#End Region
#Region " Métodos Privados "
        Private Shared Function LlenarEntidad(ByVal dr As DataRow) As TipoBeneficio
            Dim entidad As New TipoBeneficio
            ' DBE
            ...
            'Public Property IdTipoTipoBeneficio() As Integer = 0
            ...
            If dr.Table.Columns.Contains("IdTipoBeneficio") Then
                If dr.Item("IdTipoBeneficio") IsNot DBNull.Value Then
                    entidad.IdEntidad = CInt(dr.Item("IdTipoBeneficio"))
                End If
            End If
            If dr.Table.Columns.Contains("TipoBeneficio") Then
                If dr.Item("TipoBeneficio") IsNot DBNull.Value Then
                    entidad.Nombre = dr.Item("TipoBeneficio").ToString.Trim.ToUpper
                End If
            End If
            Return entidad
        End Function
#End Region
    End Class ' DAL_TipoBeneficio
